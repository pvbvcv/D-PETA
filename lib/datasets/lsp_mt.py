...
class LSP_mt(Body16KeypointDataset):
    ...
    """
    def __init__(self, root, tgt_list=None, split='train', task='all', download=False, image_size=(224, 224), k=1, 
                    transforms_base=None, transforms_ori_stu=None, transforms_ori_tea=None, transforms_stu=None, transforms_tea=None, **kwargs):
        if download:
        ...
        self.transforms_ori_stu = transforms_ori_stu
        self.transforms_ori_tea = transforms_ori_tea
        self.k = k
    ...
    def __getitem__(self, index):
        ...
        image_ori_stu, data_ori_stu = self.transforms_ori_stu(image, keypoint2d=keypoint2d, intrinsic_matrix=None)
        ...
        image_ori_tea, data_ori_tea = self.transforms_ori_tea(image, keypoint2d=keypoint2d, intrinsic_matrix=None)
        ...
        image_ori_stu = image_ori_stu[:, start:end, start:end]
        image_ori_tea = image_ori_tea[:, start:end, start:end]
        return image_ori_stu, image_ori_tea, image_stu, target_stu, target_weight_stu, meta_stu, images_tea, targets_tea, target_weights_tea, metas_tea

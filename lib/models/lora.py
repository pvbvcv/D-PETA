...
class LoRA_ViT(nn.Module):
    ...
    def __init__(self, vit_model: None, r: int, alpha: int, num_classes: int = 0, lora_layer=None):
        ...
        for t_layer_i, blk in enumerate(vit_model.blocks):
            ...
            w_a_linear_qkv = nn.Linear(dim, r, bias=False)
            w_b_linear_qkv = nn.Linear(r, dim*3, bias=False)
            ...
            blk.attn.qkv = _LoRALayer(w_qkv_linear, w_a_linear_qkv, w_b_linear_qkv, r, alpha)

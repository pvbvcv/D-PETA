...
def pretrain(train_source_iter, student, criterion, stu_optimizer, epoch: int, visualize, args: argparse.Namespace):
    ...
    # print("-------训练时间为{}------".format(training_time))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log", type=str, default='logs/human/surreal_log',
    ...
    parser.add_argument('--pretrain-epoch', type=int, default=45,
                        help='pretrain-epoch')
    parser.add_argument("--source_out", type=str, default='/DATA/pengbaichao/logs/human/source_vit_model_dino')
